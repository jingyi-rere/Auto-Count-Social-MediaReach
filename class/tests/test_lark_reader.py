...
class TestGetNewRows:
    def test_returns_row_with_url_but_no_date_or_views(self, monkeypatch):
        ...
        monkeypatch.setattr(lark_reader, "_list_records",
                            lambda pt: _mock_list_records(records))
    ...
    def test_mixed_rows_returns_only_unprocessed(self, monkeypatch):
        records = [
            ...
            _make_record("rec2", "https://instagram.com/reel/abc/",
                         has_date=True, has_views=True),                        # skip — done
            _make_record("rec3", "https://tiktok.com/@user/video/123"),        # needs processing
